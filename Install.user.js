...
if ((!document.getElementById('report-this')) && typeof Scratch.INIT_DATA.LOGGED_IN_USER.model !== 'undefined') {
    try {
        ...
        alert("Animated Thumbnail found an unxpected error. Please tell to the developer (@JuegOStrower) in her profile comments to fix the problem.");
        console.log(e);
    }
}
